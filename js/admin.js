...
async function loadOrders() {
    ...
    // Если админ сейчас что-то ищет — не сбрасываем фильтр фоновым обновлением
...
/* ================= ЖИВОЕ ОБНОВЛЕНИЕ ЗАКАЗОВ И ОТЗЫВОВ ================= */
/*
   Раньше список заказов/отзывов и бейджи обновлялись только при загрузке
   страницы. Добавляем Realtime (основной способ) + фоновый опрос раз в 15
   секунд (подстраховка на случай, если Realtime не включён в проекте).
*/
